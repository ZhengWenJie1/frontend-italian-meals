...
**Studente:** Wen Jie Zheng
**Repo:** https://github.com/ZhengWenJie1/frontend-italian-meals.git
...
Collegare AuthContext.tsx (già scritto, non ancora usato) in App.tsx; al momento l'utente autenticato passa via parametri di navigazione (navigation.replace("Home", { user })), non come stato globale.
Aggiungere "scheme": "myapp" in app.json per far funzionare il prefisso di deep link myapp:// anche fuori da Expo Go (build standalone EAS).
